...
import { TaskFileInfoI } from "../../Utiles/hooks/types/tasks";
              ...
              <Box>
                {!!taskDetails?.files.length ? (
                  ...
                  <NotFound
                    ...
                    description="Click “Upload File” to add files to your task"
                    type="search"
                  />
                )}
              </Box>
            ...
            {openReference && (
              <Box>
                {taskDetails?.files.length ? (
                  ...
                  <NotFound title="No files found!" type="search" />
                )}
              </Box>
            )}
          </Box>
          <Box className="taskModelContainer4">
            ...
            <Box className="taskModelFooter">
              <Button
                ...
                sx={() => ({
                  background: disabledButton ? "#FAFAFA" : "",
                })}
              ...
              <Button
                ...
                sx={() => ({
                  backgroundColor: disabledButton ? "#FAFAFA" : "",
                })}
                disabled={disabledButton}
              >
                Complete task

...
import { useAuth, helpers } from "../../Utiles/hooks";
...
const SignIn = () => {
  ...
  /**
   * check and submit email and password for verfication
   */
  ...
  const handleSubmit = () => {
    if (email && helpers.regexPattern.email.test(email)) {
      handleSubmitEmail();
    } else {
      setEmailError(true);
    }
      ...
      <Box className="contentWrapper">
          ...
          {!isEmailVerified ? (
            <Box className="inputWrapper">
              <InputField
                ...
                error={emailError}
                errorMessage={
                  !email ? "Please enter your email address" : "Invalid Email"
                }
              />
            </Box>
          ) : (
        ...
        <Box display="flex" justifyContent="center">
          {!isEmailVerified ? (
            ...
            <Button onClick={handleSubmitLogin} className="loginButton">
              Login
            </Button>
          )}
        </Box>

const TASK_SERVER_URL = process.env.TASK_URL || "";

const GUIDELINE_SERVER_URL = process.env.GUIDELINE_URL || "";

const REDIRECT_SERVER_URL = process.env.REDIRECT_URL|| "";

const AUTH_SERVER_URL = process.env.AUTH_URL || ""

...
console.log(groupedDuplicates)

  // const handleSwatches = () => {
  //   const allColor = list.flat()
  //   const obj = Object.assign({} , allColor)
  //   console.log(obj)
  //   csInterface.evalScript(`createSwatches('${JSON.stringify(obj)}')`)
  // }
  ...
  return (
    <BoxConatiner>
      ...
      {/* <Box className="colorBottomLine">
        <Divider />
        <Button className="containedColor" variant="contained" onClick={handleSwatches}>

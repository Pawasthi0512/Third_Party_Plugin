...
// const TypographyComp = lazy(() => import("../Typography"))
    ...
    <BoxContainer>
      ...
      >
        ...
        <Box sx={wrapper}>
          ...
          <Typography sx={colorActionButton}>ITC-Classmate </Typography>
        </Box>
        <Box sx={wrapper}>
          <Box sx={{ paddingLeft: "10px", width: "16px", height: "16px" , '&:hover':{color:'red'} }}>
            <Tick />
          </Box>
          <Typography sx={colorActionButton}>ITC-PaperKart </Typography>
        </Box>
        <Divider /> */}
